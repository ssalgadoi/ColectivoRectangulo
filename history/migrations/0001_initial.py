    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', embed_video.fields.EmbedVideoField(help_text='Ingrese el enlace del video de Vimeo', verbose_name='Enlace del video')),
                ('data', models.CharField(max_length=200, verbose_name='Datos')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Fecha de edición')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Autor')),
                ('category', models.ManyToManyField(related_name='get_posts', to='history.category', verbose_name='Categorías')),
            ],
            options={
